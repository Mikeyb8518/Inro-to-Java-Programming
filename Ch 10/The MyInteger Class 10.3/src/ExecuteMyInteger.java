public class ExecuteMyInteger {
    public static void main(String[] args) {
        ...
        System.out.println("\nTest if the values are odd using isOdd():");
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            MyInteger value = new MyInteger(values[i]);
        ...
        System.out.println("\nTest if the values are prime using isPrime():");
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            MyInteger value = new MyInteger(values[i]);
        ...
        System.out.println("\nTest if the values are even using isEven(MyInteger):");
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            MyInteger value = new MyInteger(values[i]);
        ...
        System.out.println("\nTest if the values are odd using isOdd(MyInteger):");
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            MyInteger value = new MyInteger(values[i]);
        ...
        System.out.println("\nTest if the values are prime using isPrime(MyInteger):");
        for (int i = 0; i < values.length; i++) {
            // Create a MyInteger
            MyInteger value = new MyInteger(values[i]);
        ...
        // Test equals(int), equals(MyInteger)
        int[] values2 = {5, 9, 7};
